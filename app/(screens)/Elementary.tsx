    ...
    <View style={styles.inputContainer}>
      <Animated.Text
        style={[
          styles.label,
          {
            top: labelPosition.interpolate({ inputRange: [0, 1], outputRange: [35, 10] }),
        ...
        <View style={styles.formBox}>
          ...
          <View style={styles.row}>
            <View style={styles.pickerContainer}>
              <Picker selectedValue={gradeLevel} onValueChange={(val) => setGradeLevel(val)} style={styles.picker}>
            ...
            {gender !== 'Others' ? (
              <Picker
                ...
                mode="dropdown"
                style={[styles.fullWidthPicker, { flex: 1 }]} // Add flex: 1 here
              >
...
const styles = StyleSheet.create({
  ...
  input: { height: 40, borderBottomWidth: 1, borderBottomColor: '#162938', paddingHorizontal: 10, width: '100%' },
